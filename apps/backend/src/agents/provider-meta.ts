...
export const PROVIDER_META: ProviderMetaMap = {
	...
	databricks: {
		...
		// IDs are Databricks Model Serving endpoint names. Covers all chat-capable
		// foundation-model endpoints served by the workspace (not just Claude).
		...
		models: [
			...
			{ id: 'databricks-claude-sonnet-4-6', name: 'Claude Sonnet 4.6', contextWindow: 200_000 },
			{ id: 'databricks-claude-sonnet-4', name: 'Claude Sonnet 4', contextWindow: 200_000 },
			{ id: 'databricks-claude-opus-4-8', name: 'Claude Opus 4.8', contextWindow: 200_000 },
			{ id: 'databricks-claude-opus-4-7', name: 'Claude Opus 4.7', contextWindow: 200_000 },
			{ id: 'databricks-claude-opus-4-6', name: 'Claude Opus 4.6', contextWindow: 200_000 },
			{ id: 'databricks-claude-opus-4-5', name: 'Claude Opus 4.5', contextWindow: 200_000 },
			{ id: 'databricks-claude-opus-4-1', name: 'Claude Opus 4.1', contextWindow: 200_000 },
			{ id: 'databricks-claude-haiku-4-5', name: 'Claude Haiku 4.5', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-5', name: 'GPT 5.5', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-5-pro', name: 'GPT 5.5 Pro', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-4', name: 'GPT 5.4', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-4-mini', name: 'GPT 5.4 Mini', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-4-nano', name: 'GPT 5.4 Nano', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-3-codex', name: 'GPT 5.3 Codex', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-2', name: 'GPT 5.2', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-2-codex', name: 'GPT 5.2 Codex', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-1', name: 'GPT 5.1', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5', name: 'GPT 5', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-mini', name: 'GPT 5 Mini', contextWindow: 200_000 },
			{ id: 'databricks-gpt-5-nano', name: 'GPT 5 Nano', contextWindow: 200_000 },
			{ id: 'databricks-gpt-oss-120b', name: 'GPT-OSS 120B', contextWindow: 200_000 },
			{ id: 'databricks-gpt-oss-20b', name: 'GPT-OSS 20B', contextWindow: 200_000 },
			{ id: 'databricks-gemini-3-5-flash', name: 'Gemini 3.5 Flash', contextWindow: 200_000 },
			{ id: 'databricks-gemini-3-1-flash-lite', name: 'Gemini 3.1 Flash Lite', contextWindow: 200_000 },
			{ id: 'databricks-gemini-2-5-pro', name: 'Gemini 2.5 Pro', contextWindow: 200_000 },
			{ id: 'databricks-gemini-2-5-flash', name: 'Gemini 2.5 Flash', contextWindow: 200_000 },
			{ id: 'databricks-gemma-3-12b', name: 'Gemma 3 12B', contextWindow: 200_000 },
			{ id: 'databricks-llama-4-maverick', name: 'Llama 4 Maverick', contextWindow: 200_000 },
			{ id: 'databricks-meta-llama-3-3-70b-instruct', name: 'Llama 3.3 70B Instruct', contextWindow: 200_000 },
			{ id: 'databricks-meta-llama-3-1-8b-instruct', name: 'Llama 3.1 8B Instruct', contextWindow: 200_000 },
			{ id: 'databricks-qwen3-next-80b-a3b-instruct', name: 'Qwen3-Next 80B Instruct', contextWindow: 200_000 },
			{ id: 'databricks-qwen35-122b-a10b', name: 'Qwen3.5 122B', contextWindow: 200_000 },
		],
	},
};
